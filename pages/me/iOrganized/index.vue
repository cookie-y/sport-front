<template>
  <view class="mr-15 ml-15">
    <navigationBar title="我举办的" />

    <view class="flex-inline mt-10">
      <u-button type="primary" size="small" text="举办比赛" icon="plus" @click="handleAdd" />
    </view>

    <view>
      <raceItem v-for="item in raceList" :key="item.raceId" showOperation :raceData="item" @delRace="handleDel" />
    </view>
...
// 处理新增
const handleAdd = () => {
  uni.navigateTo({ url: `/pages/me/iOrganized/editNotice` });
};
